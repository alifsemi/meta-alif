...
do_install() {
        [ -f ${B}/${TF-A_PLATFORM}/bl32.bin ] && install -D -p -m 0644 ${B}/${TF-A_PLATFORM}/bl32.bin ${D}/bl32.bin
        [ -f ${B}/${TF-A_PLATFORM}/fdts/bolt_fpga.dtb ] && install -D -p -m 0644 ${B}/${TF-A_PLATFORM}/fdts/bolt_fpga.dtb ${D}/bolt_fpga.dtb
...
do_deploy() {
       ...
       install -D -p -m 0644 ${D}/${TF-A_PLATFORM}.fip ${DEPLOYDIR}/${TF-A_PLATFORM}.fip
}

addtask deploy before do_build after do_install

FILES_${PN} = "/bl32.bin /bolt_fpga.dtb /${TF-A_PLATFORM}.fip"
