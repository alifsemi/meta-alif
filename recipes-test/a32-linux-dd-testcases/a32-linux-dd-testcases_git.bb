...
PACKAGES =. "${PN}-cdc200 ${PN}-hwsem ${PN}-watchdog ${PN}-mhu ${PN}-crc ${PN}-utimer ${PN}-cpufreq libmhuservices libmhuservices-dev "
...
FILES:${PN}-cpufreq = "/opt/linux_dd_test/cpufreq/cpu_benchmark /opt/linux_dd_test/cpufreq/cpufreq_bench_test.sh /opt/linux_dd_test/cpufreq/cpufreq_validation.sh"
